...
// and the position of the output (3). To handle this opcode, you first need to get the values at the input
// \ positions: position 9 contains 30, and position 10 contains 40. Add these numbers together to get 70. 
